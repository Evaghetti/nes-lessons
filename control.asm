...
.define CONTROLADDR $4016

.define BOTAO_A      %01000000
.define BOTAO_B      %10000000
.define BOTAO_SELECT %00010000
.define BOTAO_START  %00100000
.define BOTAO_UP     %00000100
.define BOTAO_DOWN   %00001000
.define BOTAO_LEFT   %00000001
.define BOTAO_RIGHT  %00000010

.define nmiAconteceu    $0000
.define playerX         $0001
.define playerY         $0002
.define controlePlayer1 $0005
...
.proc main
    ...
    JSR lerControle ; Le o controle 1 para processar os botoes.

    LDA controlePlayer1
    
    @VerificaDireita:
    AND #BOTAO_RIGHT
    BNE @VerificaEsquerda
    INC playerX

    @VerificaEsquerda:
    LDA controlePlayer1
    AND #BOTAO_LEFT
    BNE @FimProocessarControle
    DEC playerX
    
    @FimProocessarControle:
...
.proc lerControle
    ; Diz pro NES que eu quero ler o controle
    LDA #$01
    STA CONTROLADDR
    LDA #$00
    STA CONTROLADDR

    STA controlePlayer1 ; Reseta a variavel com os botoes apertados
    LDX #$08 ; Contador de quantos botoes preciso ler, controle tem 8 botoes
    LendoControle:
        LDA CONTROLADDR ; Le um botao
        LSR A ; Faz um Shift Right, o bit 0 vai pro Carry
        ROL controlePlayer1 ; Faz um shift left, o carry vai pro bit 0.

        DEX ; Loopa enquanto tem botao pra eu ler.
        BNE LendoControle
    RTS
.endproc
